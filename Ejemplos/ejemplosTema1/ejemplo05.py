...
calidades = [5, 50, 95];  # Porcentaje de calidad al guardar el JPG

imagenOriginalPNG = ski.io.imread("images/tablero.png")
for calidad in calidades:
    imageio.imsave(f"images/tablero{calidad}.jpg", imagenOriginalPNG, quality=calidad)
    imagenGuardadaJPG = ski.io.imread(f"images/tablero{calidad}.jpg")
    ...
    print(f"\nCALIDAD: {calidad}%  Tamaño PNG: {os.path.getsize('images/tablero.png')} Tamaño JPG: {os.path.getsize(f'images/tablero{calidad}.jpg')}")
